...
// Define the interface for NavItem
interface NavItem {
  label: string;
  page: string;
}
...
export default function Navbar() {
  // Extract theme-related properties using useTheme
  ...
  // State to manage the mobile navbar visibility
          ...
          <div className="flex items-center justify-between py-3 md:py-5 md:block">
            <Link to="home">
              <div className="container flex items-center space-x-2">
                <h2 className="text-2xl font-bold glitter-text">MH</h2>
              </div>
            </Link>
